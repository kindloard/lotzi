...
export function ShopHeaderMobile({
  ...
  return (
    <header className="sticky top-0 z-50 flex h-14 w-full items-center bg-brand px-4 md:hidden gap-3 shadow-sm">
      ...
      <div className="flex min-w-0 flex-1 flex-col justify-center">
        ...
        <div className="relative h-[16px] w-full overflow-hidden mt-0.5">
          ...
          >
            {ticks.map((tick, i) => (
              <span key={i} className="flex h-[16px] items-center gap-1 text-[11px] font-medium text-slate-800 truncate">
