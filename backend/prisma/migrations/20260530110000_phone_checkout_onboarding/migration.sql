...
CREATE TABLE "checkout_onboarding_flows" (
...
CREATE UNIQUE INDEX "checkout_onboarding_flows_flow_token_hash_key"
  ON "checkout_onboarding_flows" ("flow_token_hash");

CREATE UNIQUE INDEX "checkout_onboarding_flows_idempotency_key_hash_key"
  ON "checkout_onboarding_flows" ("idempotency_key_hash");

CREATE INDEX "checkout_onboarding_flows_phone_number_status_created_at_idx"
  ON "checkout_onboarding_flows" ("phone_number", "status", "created_at");

CREATE INDEX "checkout_onboarding_flows_status_expires_at_idx"
...
CREATE UNIQUE INDEX "phone_otp_verifications_otp_reference_id_key"
  ON "phone_otp_verifications" ("otp_reference_id");

CREATE UNIQUE INDEX "phone_otp_verifications_flow_id_idempotency_key_key"
  ON "phone_otp_verifications" ("flow_id", "idempotency_key");

CREATE INDEX "phone_otp_verifications_phone_number_status_created_at_idx"
  ON "phone_otp_verifications" ("phone_number", "status", "created_at");

CREATE INDEX "phone_otp_verifications_flow_id_status_created_at_idx"
  ON "phone_otp_verifications" ("flow_id", "status", "created_at");

CREATE INDEX "phone_otp_verifications_status_expires_at_idx"
